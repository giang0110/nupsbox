...
describe('phase2 permission matrix', () => {
  it('allows admin every Phase 2 management surface', () => {
  ...
  it('allows staff operations but denies sensitive settings and exports', () => {
  ...
  it('keeps viewer read-only while allowing approved read surfaces', () => {
    ...
    expect(can('viewer', 'leads:assign')).toBe(false);
